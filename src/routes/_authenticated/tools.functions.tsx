...
export const Route = createFileRoute("/_authenticated/tools/functions")({
  component: FunctionsExplorerPage,
});
...
function FunctionsExplorerPage() {
  const [tab, setTab] = useState("lineal");
  return (
    <div className="mx-auto max-w-5xl px-6 py-8 md:py-12">
      <div>
        <h1 className="font-display text-3xl font-bold">Explorador de funciones</h1>
