      ...
      >
        <div className="flex items-start justify-between gap-3">
          <div className="flex items-center gap-3 min-w-0">
            <div
              className={`grid h-10 w-10 shrink-0 place-items-center rounded-xl bg-gradient-to-br ${topicGradient(aggregate.topic.color)}`}
            >
          ...
          <span
            className={`flex shrink-0 items-center gap-1 rounded-full bg-muted/60 px-2 py-0.5 text-[10px] font-semibold ${trend.tone}`}
          >
